...
const serviceCards = [
  {
    ...
    description: 'Conferences, networking events, brand activations, celebrations, and community events captured with intention.',
  ...
  },
  {
    ...
    description: 'Consistent professional headshots for teams of 5+ with studio and on-location options.',
  ...
  },
  {
    ...
    description: 'Strategic images for websites, campaigns, social content, and professional visibility.',
  ...
  },
  {
    ...
    description: 'Individual headshots, studio portraits, and outdoor sessions created with a polished, intentional look.',
