...
export const fallbackSettings: SiteSettings = {
  ...
  primaryCta: {label: 'Choose Your Service', destination: '#services'},
...
export const fallbackHome: HomePage = {
  ...
  trustPoints: [
    {title: 'Clear, professional process', description: 'Clear communication from inquiry through delivery.'},
